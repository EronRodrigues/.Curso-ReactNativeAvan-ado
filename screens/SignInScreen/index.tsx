import { KeyboardAvoidingView, View, Keyboard, Animated } from "react-native";
            ...
            <Animated.View style={[styles.logoContainer, { height: logoSize }]}>
                {
                    isLottieVisible ?
                        ...
                        <Animated.Image source={require("../../assets/logo-static.png")} style={{ height: logoSize, width: logoSize}}/>
                }
            </Animated.View>
